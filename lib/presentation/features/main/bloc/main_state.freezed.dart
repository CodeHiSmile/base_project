...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MainState&&(identical(other.loadStatus, loadStatus) || other.loadStatus == loadStatus));
}
...
@override
String toString() {
  return 'MainState(loadStatus: $loadStatus)';
}
...
class _MainState extends MainState {
  const _MainState({this.loadStatus = LoadingStatus.initial}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MainState&&(identical(other.loadStatus, loadStatus) || other.loadStatus == loadStatus));
}

...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProfileState&&(identical(other.loadStatus, loadStatus) || other.loadStatus == loadStatus));
}
...
@override
String toString() {
  return 'ProfileState(loadStatus: $loadStatus)';
}
...
class _ProfileState extends ProfileState {
  const _ProfileState({this.loadStatus = LoadingStatus.initial}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProfileState&&(identical(other.loadStatus, loadStatus) || other.loadStatus == loadStatus));
}

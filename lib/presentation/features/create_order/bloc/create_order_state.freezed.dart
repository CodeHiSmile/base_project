...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateOrderState&&(identical(other.loadStatus, loadStatus) || other.loadStatus == loadStatus));
}
...
@override
String toString() {
  return 'CreateOrderState(loadStatus: $loadStatus)';
}
...
class _CreateOrderState extends CreateOrderState {
  const _CreateOrderState({this.loadStatus = LoadingStatus.initial}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateOrderState&&(identical(other.loadStatus, loadStatus) || other.loadStatus == loadStatus));
}

...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashState&&(identical(other.loadStatus, loadStatus) || other.loadStatus == loadStatus));
}
...
@override
String toString() {
  return 'SplashState(loadStatus: $loadStatus)';
}
...
class _SplashState extends SplashState {
  const _SplashState({this.loadStatus = LoadingStatus.initial}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SplashState&&(identical(other.loadStatus, loadStatus) || other.loadStatus == loadStatus));
}
